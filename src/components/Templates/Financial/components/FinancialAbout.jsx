...
import './FinancialAbout.css'

const FinancialAbout = () => {
    return (
        <div className='financialAbout' id='about'>
            <div className='container'>
                <img src='/images/Financial/john-doe.png' alt='john' />
                <div className='col-2'>
                    <h2>About</h2>
