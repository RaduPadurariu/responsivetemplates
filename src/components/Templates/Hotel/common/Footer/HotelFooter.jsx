        ...
        <div className='container grid'>
          ...
          <div className='box'>
            ...
            <ul>
              ...
              <li>
                <Link to='/hotel/about'>About us</Link>
              </li>
              <li>
                <Link to='/hotel/gallery'>Gallery</Link>
              </li>
              <li>
                <Link to='/hotel/destinations'>Destinations</Link>
              </li>
              <li>
                <Link to='/hotel/blog'>Blog</Link>
              </li>
              <li>
                <Link to='/hotel/testimonial'>Testimonial</Link>
              </li>
              <li>
                <Link to='/hotel/contact'>Contact Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div className='box'>
            ...
            <input type='text' className='primary-btn' defaultValue='SUBSCRIBE' />
          </div>
        </div>
      </footer>
      <div className='legal'>
